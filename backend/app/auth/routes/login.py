...
from backend.app.core.exceptions import UnauthorizedError, ValidationFailedError
...
async def request_login_otp(
    ...
    """First login step: verify the password and email an OTP.
    ...
    if user:
        ...
        if not await user_auth_service.verify_user_password(
            ...
            remaining_attempts = settings.LOGIN_ATTEMPTS - user.failed_login_attempts
            ...
            if remaining_attempts > 0:
                ...
                error_message = (
                    ...
                    "to too many failed attempts. Please try again after "
...
async def verify_login_otp(
    ...
    """Second login step: verify the OTP and set the JWT auth cookies."""
