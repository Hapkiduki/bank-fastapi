...
def upgrade() -> None:
    ...
    op.create_table(
        ...
        sa.Column(
            "account_type",
            sa.Enum(
                "Current", "Savings", "FixedDeposit", "Business", name="accounttypeenum"
            ),
            nullable=False,
        ),
        sa.Column(
            "currency",
            sa.Enum("USD", "EUR", "GBP", "KES", name="accountcurrencyenum"),
            nullable=False,
        ),
        sa.Column(
            "account_status",
        ...
        sa.Column(
            "kyc_verified_on", postgresql.TIMESTAMP(timezone=True), nullable=False
        ),
    ...
    op.create_foreign_key(
        None, "nextofkin", "user", ["user_id"], ["id"], ondelete="CASCADE"
    )
