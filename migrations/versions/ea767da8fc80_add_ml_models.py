...
Revision ID: ea767da8fc80
Revises: 11f2bd4693cb
Create Date: 2025-07-22 12:49:38.160661
...
revision: str = "ea767da8fc80"
down_revision: Union[str, None] = "11f2bd4693cb"
...
def upgrade() -> None:
    ...
    op.create_table(
        ...
        sa.Column(
            "mlflow_experiment_id", sqlmodel.sql.sqltypes.AutoString(), nullable=True
        ),
        sa.Column(
            "mlflow_model_uri", sqlmodel.sql.sqltypes.AutoString(), nullable=True
        ),
        sa.Column(
            "created_at",
    ...
    op.create_table(
        ...
        sa.Column(
            "mlflow_artifact_uri", sqlmodel.sql.sqltypes.AutoString(), nullable=True
        ),
        sa.Column(
            "feature_info", postgresql.JSONB(astext_type=sa.Text()), nullable=True
        ),
        sa.PrimaryKeyConstraint("id"),
    )
    op.create_table(
        ...
        sa.Column(
            "prediction_timestamp", postgresql.TIMESTAMP(timezone=True), nullable=False
        ),
        sa.Column(
            "input_features", postgresql.JSONB(astext_type=sa.Text()), nullable=True
        ),
    ...
    op.create_index(
        op.f("ix_modelprediction_model_id"),
        "modelprediction",
        ["model_id"],
        unique=False,
    )
    op.create_index(
        op.f("ix_modelprediction_transaction_id"),
        "modelprediction",
        ["transaction_id"],
        unique=False,
    )
...
def downgrade() -> None:
    # ### commands auto generated by Alembic - please adjust! ###
    op.drop_index(
        op.f("ix_modelprediction_transaction_id"), table_name="modelprediction"
    )
